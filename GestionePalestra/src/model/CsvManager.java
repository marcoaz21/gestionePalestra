...
public class CsvManager {
    ...
    public static List<iscritto> leggiIscritti() {
        ...
        try {
            File file = new File(CSV_FILE_PATH);
            if (!file.exists()) {
                return iscritti; // Restituisci lista vuota se il file non esiste
            }
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (data.length >= 5) {
                    // Crea un iscritto con i dati base
    ...
    public static boolean modificaIscritto(iscritto iscrittoModificato) {
        // Assicurati che tutti gli abbonamenti siano sincronizzati
        ...
        if (eliminato) {
            // Poi aggiungi la versione modificata
